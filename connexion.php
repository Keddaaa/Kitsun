    ...
    <body>
        <div class="entete">
            <header>
                <div class="header_left">
                    <div class="logo">
                        <img src="img/logo.png" alt="" onclick="location.href='index.php'" />
                    </div>
                ...
                <div class="header_right">
                    <div class="icons_right">
                        <input type="text" id="searchInput" placeholder="Rechercher" class="searchInput" />
        ...
        <main>
            ...
            <section class="form">
                ...
                <h3>ou</h3>
                <button class="mail" onclick="location.href='formulaire.php'">
                    <i class="far fa-envelope"></i> E-mail
                </button>
                <p>
                    En continuant, vous acceptez nos conditions générales et notre politique de confidentialité. Nous utilisons vos données personnelles pour vous offrir une expérience personnalisée, ainsi que pour mieux comprendre et améliorer notre service. Pour plus de détails, cliquez ici.
                </p>
            </section>
        </main>
        ...
        <footer class="footer">
            ...
            <div class="footer_container">
                <ul>
                    <li><a class="title_footer" href="index.php">Accueil</a></li>
                    <li><a href="menu.php">Menu</a></li>
                    <li><a href="localisation.php">Localisation</a></li>
                    <li><a href="localisation.php">Politique de confidentialité</a></li>
                </ul>

                <ul>
                    <li><a class="title_footer" href="index.php">Contact</a></li>
                    <li><a href="menu.php">+33 1 23 45 67 90</a></li>
                    <li><a href="localisation.php">Kitsun.pro@gmail.com</a></li>
                </ul>

                <ul>
                    <li><a class="title_footer" href="index.php">Inscrivez-vous à notre newsletter</a></li>
                    <li class="formulaire">
                        <input type="email" id="email" pattern=".+@example\.com" size="30" placeholder="Email" />
